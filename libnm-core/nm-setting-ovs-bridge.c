 ...
 * @s_ovs_bridge: the #NMSettingOvsBridge
 *
 ...
 **/
const char *
nm_setting_ovs_bridge_get_fail_mode (NMSettingOvsBridge *s_ovs_bridge)
{
	g_return_val_if_fail (NM_IS_SETTING_OVS_BRIDGE (s_ovs_bridge), NULL);

	return s_ovs_bridge->fail_mode;
}
 ...
 **/
gboolean
nm_setting_ovs_bridge_get_mcast_snooping_enable (NMSettingOvsBridge *s_ovs_bridge)
{
	g_return_val_if_fail (NM_IS_SETTING_OVS_BRIDGE (s_ovs_bridge), FALSE);

	return s_ovs_bridge->mcast_snooping_enable;
}
 ...
 **/
gboolean
nm_setting_ovs_bridge_get_rstp_enable (NMSettingOvsBridge *s_ovs_bridge)
{
	g_return_val_if_fail (NM_IS_SETTING_OVS_BRIDGE (s_ovs_bridge), FALSE);

	return s_ovs_bridge->rstp_enable;
}
 ...
 **/
gboolean
nm_setting_ovs_bridge_get_stp_enable (NMSettingOvsBridge *s_ovs_bridge)
{
	g_return_val_if_fail (NM_IS_SETTING_OVS_BRIDGE (s_ovs_bridge), FALSE);
              ...
              GValue *value, GParamSpec *pspec)
{
	...
	switch (prop_id) {
	case PROP_FAIL_MODE:
		g_value_set_string (value, s_ovs_bridge->fail_mode);
		break;
	case PROP_MCAST_SNOOPING_ENABLE:
		g_value_set_boolean (value, s_ovs_bridge->mcast_snooping_enable);
		break;
	case PROP_RSTP_ENABLE:
		g_value_set_boolean (value, s_ovs_bridge->rstp_enable);
		break;
	case PROP_STP_ENABLE:
		g_value_set_boolean (value, s_ovs_bridge->stp_enable);
		break;
	default:
